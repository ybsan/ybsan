        ...
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item">
                    <a href="javascript:;"><img src="layuiadmin\pic\logo1.jpg" class="layui-nav-img">${loginName}</a>
                </li>
                <li class="layui-nav-item">
                    <a href="">个人中心<span class="layui-badge-dot"></span></a>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;"><i class="layui-icon layui-icon-edit"></i>修改密码</a>
                </li>
                    ...
                    <div id="Adminrole" style="display: none">
                        ...
                        <li data-name="home" class="layui-nav-item ">
                            ...
                            <dl class="layui-nav-child">
                                ...
                                <dd data-name="console">
                                    <a lay-href="home/homepage1.html">选课统计</a>
                                </dd>
                            </dl>
                        </li>
                        <li data-name="home" class="layui-nav-item">
