            ...
            <form class="layui-form" action="" lay-filter="component-form-group">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="birthday" lay-verify="date" id="LAY-component-form-group-date2" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input" value="${student.birth}">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="password" name="password" lay-verify="required" placeholder="请输入密码" autocomplete="off" class="layui-input" value="${student.password}">
                    </div>
                </div>
...
<script>
    layui.config({
        ...
        form.on('submit(component-form-demo1)', function(data){
            ...
            $.post("/student/upd", studentObj,function (result) {
