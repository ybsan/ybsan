...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm"  action="${pageContext.request.contextPath}/emp/padd?id=${employee.id }">
        <input type="hidden" name="staticid" id="staticid" value="${sessionScope.user_session.empId}" >
