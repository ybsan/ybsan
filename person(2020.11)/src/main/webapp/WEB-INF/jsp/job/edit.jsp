...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm"  action="${pageContext.request.contextPath}/job/upd">
        <input type="hidden" name="id" id="id" value="${jobInf.id }" >
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${jobInf.name }">
              </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${jobInf.remark }">
              </div>
