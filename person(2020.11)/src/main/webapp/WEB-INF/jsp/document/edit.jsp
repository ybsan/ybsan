...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm" enctype="multipart/form-data" action="${pageContext.request.contextPath }/document/upd">
        <input type="hidden" name="id" id="id" value="${documentInf.id }" >
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="title" name="title" required="" lay-verify="required"
                   placeholder="不少于3个汉字" autocomplete="off" class="layui-input" value="${documentInf.title }">
              </div>
        ...
        <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  placeholder="不少于5个汉字"  autocomplete="off" class="layui-input" value="${documentInf.remark}">
              </div>
