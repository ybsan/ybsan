...
setTimeout(function(){document.getElementById("new_message").style.display="none";},10000);
 ...
 var num=1;
$(function(){
       $('#verifyCodeImage').attr('src','${pageContext.request.contextPath }/getpic?num='+num);
});	
</script> 
<script type="text/javascript">
...
function changeImage() {
     $('#verifyCodeImage').attr('src',
             '${pageContext.request.contextPath }/getpic?timestamp=' + genTimestamp());
 }
</script> 
<style type="text/css">
body{
...
<div style="width: 100%;height:48px; background-color:RGB(43,48,59) ">
    ...
    <div id="main" style="width:100%;height:700px;float:left;">
          
      <div class="container" style="background-color:rgb(73,74,95);width: 100%;height:680px;float:left;">
        <!-- <div  style="background-color:green;width: 1360px;height:610px; float:left;"> -->
       <!-- 幻灯片 -->
       
       <div class="testSlider" style="margin-left:-15px;"></div>
         
		 <div id="register"  class="register" style="height:370px;margin-top:150px;margin-left:325px;opacity:0.9;">
            <div class="title">
            ...
            <form  method="post" action="${pageContext.request.contextPath }/user/login" name="check-form" id="toLoginForm">
                
                <div class="default" style="margin-top:40px;">
                    <input 	data-form="uname" type="text" placeholder="请输入登录名"  onchange="tocheckLoginname()"  id="loginname" name="loginname" value="sunwukong"/>
                </div>
                ...
                <div class="default">
                    <input id="password" name="password"
									value="sun123" data-form="upwd" type="password" placeholder="请输入账号密码 " />
                </div>
       ...
       <!-- 底部开始 -->
     <div style="width: 100%;height:88px; background-color:RGB(43,48,59) ;margin-top:650px;">
