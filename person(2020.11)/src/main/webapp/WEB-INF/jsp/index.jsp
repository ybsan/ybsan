...
<head>
	...
	//这个事件不能一直点击
		  $(function() { // 页面装载执行
				$("#bt").click(function(){ // 为ID为 的标签绑定click事件
					$.ajax({
					    method:'get',
...
<body oncontextmenu="self.event.returnValue=false" onselectstart="return false">
          ...
          <li class="layui-nav-item">
           <a href="javascript:;">${sessionScope.user_session.username}</a>
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
              <dd><a href="javascript:void(0);" id="exit" name="exit"  onclick="logout()">注销退出</a></dd>
            </dl>
          </li>
        </ul>
        ...
        <ul id="nav">
            ...
            <li id="employee">
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a _href="${pageContext.request.contextPath}/emp/toassociation">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加员工</cite>
                        </a>
                    </li >
            ...
            <li id="peremployee">
                ...
                <ul class="sub-menu">
                    ...
                    <li >
                        ...
                        <a _href="${pageContext.request.contextPath}/emp/toplist?id=${sessionScope.user_session.empId}"><!--session中获取员工信息的id  -->
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>个人信息</cite>
                        </a>
                    </li >
                    ...
                    <li>
                        <!-- 这里首先需要默认一个员工的id，因为第一次注册登录，没有员工信息，所以这个id如何设置 -->
                        <a _href="${pageContext.request.contextPath}/emp/topadd?id=${sessionScope.user_session.empId}&email=${sessionScope.user_session.email}"><!--session中获取员工信息的id  -->
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>完善个人信息</cite>
                        </a>
                    </li >
                    ...
                    <li >
                        <!-- 这里首先需要默认一个员工的id，因为第一次注册登录，没有员工信息，所以这个id如何设置 -->
                        <a _href="${pageContext.request.contextPath}/emp/topedit?id=${sessionScope.user_session.empId}"><!--session中获取员工信息的id  -->
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>修改个人信息</cite>
                        </a>
                    </li >
 ...
 <!--新增用户请假功能  部门经理进行审批-->            
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/leave/list">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>请假申请</cite>
                        </a>
                    </li >
 ...
 <!--************************************************************************************* -->                  
            ...
            <li id="pcheckwork">
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/checkwork/topedit?empId=${sessionScope.user_session.empId}">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>查看考勤</cite>
                        </a>
                    </li >
...
<!--新增用户请假功能  填写请假信息，做提交给数据库，为请假详情列表，-->
                 <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/checkwork/toleaveadd?empId=${sessionScope.user_session.empId}">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>我要请假</cite>
                        </a>
                    </li >
...
<!--我的请假直接通过id去查询请假详情列表，简单的查询功能，用户可以删除自己的请假信息   -->                
                  <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/checkwork/leavelist?empId=${sessionScope.user_session.empId}">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>我的请假</cite>
                        </a>
                    </li >
...
<!--************************************************************************************* -->            
            ...
            <li id="psalary">
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/salary/topedit?empId=${sessionScope.user_session.empId}">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>查看薪酬</cite>
                        </a>
                    </li >
            ...
            <li id="pcontract">
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/contract/pedit?empId=${sessionScope.user_session.empId}">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>查看合同</cite>
                        </a>
                    </li >
            ...
            <li id="train">
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/train/totrain">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>培训计划</cite>
                        </a>
                    </li >
                    <!-- 新增培训评价及详细信息 -->
                    <li>
                        <a _href="${pageContext.request.contextPath}/train/admintrainlist?empId=${sessionScope.user_session.empId}">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>我的培训</cite>
                        </a>
                    </li >
            ...
            <li id ="admintrain">
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a _href="${pageContext.request.contextPath}/train/list">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>培训详情</cite>
                        </a>
                    </li >
    ...
    <div class="footer" style="background-color:RGB(43,48,59)">
        <div class="copyright" align="center"style="background-color:RGB(43,48,59)">Copyright ©2021 </div>
    </div>
    <!-- 底部结束 -->
