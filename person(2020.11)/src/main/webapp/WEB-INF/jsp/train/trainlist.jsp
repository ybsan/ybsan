...
<html>
  ...
  <body>
    <div class="x-nav">
      ...
      <a  class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${pageContext.request.contextPath }/train/list" title="刷新">
        <i class="layui-icon" style="line-height:30px">ဂ</i></a>
    </div>
    <div class="x-body">
    <div class="layui-row" style="" align="center">
        <form class="layui-form layui-col-md12 x-so" method="get" action="${pageContext.request.contextPath }/train/list">
     ...
     <tr>
            <td>
			 ...
			 <td>
                         <c:choose>
                             <c:when test="${train.completion==1}">优秀</c:when>
                             <c:when test="${train.completion==2}">良好</c:when>
         ...
         <td><fmt:formatDate value="${train.traintime}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
             ...
             <td class="td-manage">
              ...
              <a title="编辑"  href='${pageContext.request.contextPath}/train/toupd?id=${train.id}'>
    ...
    <script>
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
              //发异步删除数据
              //等以后再使用异步，这里先使用
              $.get("${pageContext.request.contextPath}/train/del?id="+id);
