...
$(function(){
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm"  action="${pageContext.request.contextPath}/train/upd">
        <!-- id为员工信息id（也就是全局id） -->
        <input type="hidden" name="id" id="id" value="${train.id }" >
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select id="empId" name="empId" class="valid">
                    <c:forEach items="${requestScope.emp_list}" var="emp">
                        <c:choose>
                            <c:when test="${train.empId== emp.id }">
          ...
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  <select id="completion" name="completion" class="valid">
                      <c:forEach items="${requestScope.com_list}" var="com">
                          <c:choose>
                              <c:when test="${train.completion== com.id }">
