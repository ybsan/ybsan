...
<body>
	<div class="x-nav">
		...
		<button id="aaa" type="button"
			onclick="location.href='${pageContext.request.contextPath}/dept/toadd'"
			class="layui-btn layui-btn-small"
			style="line-height: 1.6em; margin-top: 3px; float: innert; margin-left: 75%;">
			<i class="layui-icon"></i>增加
		</button>
		<a id="bbb" class="layui-btn layui-btn-small"
				...
				<c:forEach items="${requestScope.list}" var="dept" varStatus="stat">
					<tr>
						...
						<td class="td-manage"><a title="编辑"
							href='${pageContext.request.contextPath}/dept/toupd?id=${dept.id}'>
								<i class="layui-icon">&#xe642;</i>
		...
		<%-- <div style="margin-left: 400px;">
			<fkjava:pager pageIndex="${requestScope.pageModel.pageIndex}"
				...
				submitUrl="${pageContext.request.contextPath}/dept/list?pageIndex={0}" />
		</div> --%>
	</div>
	<script>
		/*用户-删除*/
