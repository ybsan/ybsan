  ...
  <body>
    <div class="x-nav">
      <span class="layui-breadcrumb">
        ...
        <a>
         ...
         <button id="bbb" type="button"  onclick="location.href='${pageContext.request.contextPath}/notice/toadd'" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:innert;margin-left:75%;;"  ><i class="layui-icon"></i>增加</button>
          <a id="aaa" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${pageContext.request.contextPath}/notice/list" title="刷新">
    ...
    <div class="x-body">
     ...
     <tr>
            ...
            <td class="td-manage" >
               <a title="编辑"  href='${pageContext.request.contextPath}/notice/toupd?id=${notice.id}'>
    ...
    <script>
        ...
        layui.use('laypage', function () {
            ...
            laypage.render({
                ...
                , jump: function (obj, first) {
                    ...
                    if (!first) {
                        //do something
                        window.location.href = "${pageContext.request.contextPath}/notice/list?pageNo=" + obj.curr + "&pageSize=" + obj.limit;
                    }
                }
            });
        });
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
              //发异步删除数据
              //等以后再使用异步，这里先使用
              $.get("${pageContext.request.contextPath}/notice/del?id="+id);
