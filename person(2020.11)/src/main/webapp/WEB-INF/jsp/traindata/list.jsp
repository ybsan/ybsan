    ...
    <table class="layui-table">
        ...
        <c:forEach items="${requestScope.list}" var="dept" varStatus="stat">
            <tr>
                ...
                <td>${dept.title }</td>
                <td>${dept.remark }</td>
                <td id="videourl">${dept.filename}
                    <button class="layui-btn layui-btn-xs" style="margin-left: 5px;" onclick="openVideo(this)">可播放</button></td>
                ...
                <td class="td-manage">
                    ...
                    <a title="编辑"  href='${pageContext.request.contextPath}/traindata/toupd?id=${dept.id}'>
...
<script>
    ...
    function member_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            //发异步删除数据
            //等以后再使用异步，这里先使用
            $.get("${pageContext.request.contextPath}/traindata/del?id="+id);
